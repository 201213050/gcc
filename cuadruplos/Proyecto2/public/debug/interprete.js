...
function llenarStack(){

	if(!estado){
		var p=tabla3D.getSimbolo("p");
		punteroPrincipal=p.valor;
		estado=false;
	}

	while(punteroPInf!=punteroPSup){

		if(metodo3DActual!=null){
			if(metodo3DActual.valor!=null){
				var ambitoReal={"ambito":metodo3DActual.valor,"valor":interprete3D.stack[punteroPInf]};
				stack[punteroPInf]=ambitoReal;
			}else{
			var ambitoReal={"ambito":"global","valor":interprete3D.stack[punteroPInf]};
			stack[punteroPInf]=ambitoReal;
								}
			}else{
			var ambitoReal={"ambito":"global","valor":interprete3D.stack[punteroPInf]}
